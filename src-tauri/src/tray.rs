...
pub fn setup_tray(app: &tauri::App) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let start = MenuItem::with_id(handle, MENU_PROXY_START, "启动代理", true, None::<&str>)?;
    let stop = MenuItem::with_id(handle, MENU_PROXY_STOP, "停止代理", true, None::<&str>)?;
