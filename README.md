...
**当前版本：0.0.4** — Windows 安装包内嵌 `model-hub-gateway`。客户端 Key 前缀为 `sk-modelhub-...`。详见 [v0.0.4 发布说明](./docs/release-notes-v0.0.4.md)。
...
4. 默认监听 `http://127.0.0.1:8080`（本机绑定）；可在设置页停止网关后修改监听端口，配置保存于 `shell.json`，下次手动启动生效。
